...
> For more theme options and methods of referencing themes, see [Blazor Themes](../../../../apm_modules/syncfusion/blazor-ui-components-skills/skills/syncfusion-blazor-themes/references/theme-appearance.md) documentation.
> 
> For different approaches to add script references, see [Adding Script Reference](../../../../apm_modules/syncfusion/blazor-ui-components-skills/skills/syncfusion-blazor-common/references/add-script-reference-and-cdn.md) documentation.
